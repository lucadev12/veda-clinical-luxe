...
This version uses the **clinical-luxe** theme:

- Palette: ivory/taupe/sage/copper
- Typography: serif display + sans body
- Spacing: editorial, varied rhythm
- Borders: clean, no radius
- Animation: refined entrance reveals, smooth scrolls
- Cards: bone bg, taupe borders, hover lift
- Images: product photography, editorial crops
- CTA buttons: copper primary, outline secondary
- Posture: premium clinical elegance, aspirational, Vogue-adjacent
